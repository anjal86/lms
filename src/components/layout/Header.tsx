...
export default function Header() {
  ...
  return (
    <>
      <header className="sticky top-0 z-30 flex h-[var(--header-height)] shrink-0 items-center justify-between border-b border-zinc-200 bg-white/95 px-3 backdrop-blur md:px-4">
        <div className="flex min-w-0 items-center gap-2.5">
          ...
          <button type="button" onClick={() => setIsCommandPaletteOpen(true)} aria-label="Search workspace" className="flex h-9 shrink-0 items-center gap-2 rounded-lg border border-zinc-200 bg-zinc-50/80 px-3 text-[13px] text-zinc-500 transition hover:border-zinc-300 hover:bg-white sm:w-72 md:w-80"><Search className="h-3.5 w-3.5 shrink-0" /><span className="hidden truncate sm:inline">Search workspace</span><kbd className="ml-auto hidden rounded-md border border-zinc-200 bg-white px-1.5 py-0.5 text-[10px] font-medium text-zinc-400 lg:inline">⌘K</kbd></button>
        </div>
