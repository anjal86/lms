...
export default function ConvertToLeadDrawer({ isOpen, onClose, conversation, onConverted, initialPhone }: ConvertToLeadDrawerProps) {
  ...
  return (
    <div className="fixed inset-0 z-50 overflow-hidden" role="dialog" aria-modal="true" aria-labelledby="convert-drawer-title" aria-busy={isSubmitting}>
      ...
      <div className="fixed inset-y-0 right-0 flex w-full max-w-full sm:pl-10">
        <div className="w-full max-w-xl border-l border-zinc-200 bg-white shadow-xl">
