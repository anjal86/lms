...
export default function WorkspaceSettingsHubPage() {
  ...
  const cards: SettingsCard[] = [
    ...
    { href: '/settings/knowledge', title: 'Knowledge', description: 'Index verified FAQs, services, pricing and policies so AI answers from workspace facts.', icon: BookOpenText, visible: true },
    { href: '/settings/ai-observability', title: 'AI Operations', description: 'Monitor model runs, latency, failures, handoffs, usage and retrieved knowledge.', icon: Gauge, visible: true },
