...
export const PROVIDERS: ProviderDefinition[] = [
  ...
  },
  {
    ...
    shortName: 'WhatsApp',
    description: 'Receive inquiries, send approved messages, and keep the full conversation with the traveler.',
    group: 'Messaging',
    capabilities: ['Messages', 'Templates', 'Delivery status', 'Conversation history'],
    envKeys: ['META_APP_ID', 'META_APP_SECRET'],
    connectMode: 'meta_oauth',
    color: 'emerald',
  },
