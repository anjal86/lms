...
const migrations = [
  ...
  { file: '202609120015_full_unique_indexes_for_upsert.sql', applied: () => exists("select to_regclass('public.idx_lead_messages_provider_ext_msg_full') is not null or to_regclass('public.lead_messages_workspace_connection_provider_ext_uidx') is not null or to_regclass('public.lead_messages_connection_external_uidx') is not null") },
